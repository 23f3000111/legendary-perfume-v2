...
export const LinkedIn = (p: P) => (
  <svg {...base(p)}><rect x="4" y="4" width="16" height="16" rx="2.5" /><path d="M8 10.5V16" /><circle cx="8" cy="7.6" r="0.9" fill="currentColor" stroke="none" /><path d="M11.5 16v-3.2a2.3 2.3 0 0 1 4.5 0V16" /></svg>
)
export const Mail = (p: P) => (
  <svg {...base(p)}><rect x="3" y="5.5" width="18" height="13" rx="1.6" /><path d="m3.6 6.6 8.4 6 8.4-6" /></svg>
)
